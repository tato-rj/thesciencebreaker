<div class="col-lg-3 col-md-3 col-sm-3 hidden-xs">
	<div id="side-bar">
		...
		<div>
			<strong><p class="mb-3"><i class="fa fa-heart mr-2" aria-hidden="true"></i>Editor's picks</p></strong>
		...
		<div>
			<strong><p class="mb-3"><i class="fa fa-star mr-2" aria-hidden="true"></i>Most popular</p></strong>
