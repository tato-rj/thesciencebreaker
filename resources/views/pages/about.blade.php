...
<div class="container mt-5">
	<div class="row">
		<div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
			...
			<div class="jumbotron">
				In summary, the scientific article “to be Breaked” can be either chosen by the Breaker or proposed by the broad public. In the first case, the Breaker can spontaneously submit a Break through the <a href="#">Submit your Break</a> page. In the latter case anyone interested in a specific topic (for example a recent discovery mentioned in the press) can request a Break through the dedicated <a href="#">Ask for a Break</a> page.
			</div>
