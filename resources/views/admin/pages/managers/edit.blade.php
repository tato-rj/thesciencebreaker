          ...
          <form method="POST" action="/admin/managers/{{ $manager->slug }}"  enctype="multipart/form-data">
            ...
            <div class="form-inline form-group">
              ...
              <div class="input-group mb-2 mr-sm-2">
                ...
                <input type="text" value="{{ $manager->position }}" name="position" class="form-control" id="position" placeholder="Position">
              </div>
              <div class="d-block">
                {{-- Errors --}}
                @component('admin/snippets/error')
            ...
            <div class="form-check">
              <label class="form-check-label mb-2">
                <input type="checkbox" value="1" {{ ($manager->is_alumni == '1') ? 'checked' : '' }} name="is_alumni" class="form-check-input" id="is_alumni">
