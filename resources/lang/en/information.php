...
return [
	'purpose' => [
		...
		'p1' => 'A “<i>break</i>” is a lay summary of a published scientific article. Its purpose is to make a (complicated) scientific finding accessible to a broader audience. Our readership ideally consists of scientists from very different areas and, above all, laypeople. It is, thus, important to address those who do not have any knowledge of the author’s background, and give them a fascinating story that inspires them to ask questions and get to know more.',
	],
	'authorship' => [
		'title' => 'AUTHORSHIP',
		'p1' => 'To be able to submit a break, authors must be <b>scientists actively pursuing their research within an academic or non-profit research institution</b>. Even though manuscripts written by several authors may be accepted, we strongly discourage any “honorary” authorship. Writing a <i>break</i> is an effort and an exercise of science communication that must be actively undertaken by all the author(s) participating. Ideally, one or two authors draft the submitted manuscript. ',
	],
	'drafting' => [
		'title' => 'DRAFTING A BREAK: STEP-BY-STEP',
		'p1' => '<b>LENGTH.</b> The main body of the manuscript must be kept between 700 and 750 words - <b>maximum</b>.',
		'p2' => '<b>TITLE.</b> Short, catchy, but NOT misleading. It could also be funny.',
		...
		'p7' => '<b>CONCLUSIONS.</b> from the study Here you should summarize the meaning of the results from above, making clear links to the initial questions and to the specific case presented in the “Introduction to study” section.',
		'p8' => '<b>GENERAL CONCLUSIONS AND FUTURE PERSPECTIVES.</b> Connect with the general context mentioned in the “General introduction” section. Feel free to state the limitations of the study (it could also be in a fun way, not super serious, but this is optional), and the new questions it allows us to explain. Also, if you deem it fit, connect back to that element of day-to-day life that you brought up in the “General introduction”. This is also the place to make questions to the reader, and spark their curiosity in more aspects of the same subject, and also discuss possible future findings.',
	],
	'tips' => [
		'title' => 'TIPS & TRICKS',
		'list' => [
			'li1' => '<b>First sentence</b> let the audience know why this research is important</li>',
			'li2' => 'Spell out its <b>relevance and impact</b> - not only the impact for the scientific community but why your non-scientist friend should care',
			'li3' => 'Structure it with <b>short sentences and paragraphs</b>',
			'li4' => '<b>Don\'t use any scientific jargon</b>, try to use simple (every-day) words and phrases',
